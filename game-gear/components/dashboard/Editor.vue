  ...
  <div>
    <v-dialog v-model="creatingStructure" persistent max-width="600px">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer />
          <v-btn color="blue darken-1" text @click="resetError()">
            Close
          </v-btn>
          <v-btn
            color="blue darken-1"
    ...
    <v-btn color="primary" dark @click="openMenu(0)">
      Insert Structure
    </v-btn>
    <div v-for="(item, index) in value" :key="index">
      <div v-if="item.content.type === 'headertitle'">
        <EditHeaderTitle v-model="value[index]" :blog="blog" />
      </div>
      ...
      <div v-else-if="item.content.type === 'ad'">
        <EditAd v-model="value[index]" :blog="blog" />
      </div>
      <div v-else-if="item.content.type === 'infobox'">
        <EditInfobox v-model="value[index]" :blog="blog" />
      </div>
      ...
      <div v-else-if="item.content.type === 'imagebox'">
        <EditImageBox v-model="value[index]" :blog="blog" />
      </div>
      <v-btn
        color="primary"
        dark
